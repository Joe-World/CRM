...
<div>
    <div style="position: relative; top: 20px; left: 40px;">
        ...
        <div style="position: relative;top: 0px;">
            <table id="activityTable2" class="table table-hover" style="width: 900px;">
                ...
                <c:forEach items="${tranList}" var="tran">
                    <tr id="tr_${tran.id}">
                        <td><a href="workbench/transaction/detailTran.do?tranId=${tran.id}" style="text-decoration: none;">${tran.name}</a></td>
                        <td>${tran.money}</td>
                        <td>${tran.stage}</td>
        ...
        <div>
            <a href="" style="text-decoration: none;" id="createTranBtn"><span class="glyphicon glyphicon-plus"></span>新建交易</a>
        </div>
    </div>
</div>
            ...
            <table id="activityTable" class="table table-hover" style="width: 900px;">
                ...
                <c:forEach items="${contactsList}" var="contacts">
                    <tr id="tr_${contacts.id}">
                        <td><a href="workbench/contacts/detail.do?id=${contacts.id}"
                               style="text-decoration: none;">${contacts.fullname}</a></td>
                        <td>${contacts.email}</td>
                        <td>${contacts.mphone}</td>
                        <td><a href="javascript:void(0);" id="deleteContactsBtn" contactsId="${contacts.id}"
